...
double rootpsix, rootpsiy; // rootpsi* - temporary variables that stores updated psi*

switch(count){
    case 1:{
        tempphi[tempindex_y][tempindex_x] = hp(phi, psix, psiy, psixy, xadv[tempindex_y][tempindex_x], yadv[tempindex_y][tempindex_x], xo, yo, dx, dy);
        rootpsix = hermx(phi,psix,psiy,psixy,xadv[tempindex_y][tempindex_x],yadv[tempindex_y][tempindex_x],xo,yo,dx, dy);
        rootpsiy = hermy(phi,psix,psiy,psixy,xadv[tempindex_y][tempindex_x],yadv[tempindex_y][tempindex_x],xo,yo,dx, dy);
        ...
        if(strcmp("Heuns",psischeme) == 0){
            ...
            graduxroot = gradUx(xadv[tempindex_y][tempindex_x], yadv[tempindex_y][tempindex_x], t * dt, T_period);
            graduyroot = gradUy(xadv[tempindex_y][tempindex_x], yadv[tempindex_y][tempindex_x], t * dt, T_period);
            gradvxroot = gradVx(xadv[tempindex_y][tempindex_x], yadv[tempindex_y][tempindex_x], t * dt, T_period);
            gradvyroot = gradVy(xadv[tempindex_y][tempindex_x], yadv[tempindex_y][tempindex_x], t * dt, T_period);
    ...
    case 2:{
        rootpsix = hermx(phi,psix,psiy,psixy,xadv[tempindex_y][tempindex_x], y[tempindex_y],xo,yo,dx, dy);
        rootpsiy = temppsiy[tempindex_y][tempindex_x];
        tempphi[tempindex_y][tempindex_x] = hp(phi, psix, psiy, psixy, xadv[tempindex_y][tempindex_x], y[tempindex_y], xo, yo, dx, dy) - dt * Vely(x[tempindex_x], y[tempindex_y], t * dt, T_period) * rootpsiy;
    ...
    case 3:{
        ...
        rootpsiy = hermy(phi,psix,psiy,psixy,x[tempindex_x],yadv[tempindex_y][tempindex_x],xo,yo,dx, dy);
        tempphi[tempindex_y][tempindex_x] = hp(phi, psix, psiy, psixy, x[tempindex_x],yadv[tempindex_y][tempindex_x], xo, yo, dx, dy) - dt * Velx(x[tempindex_x], y[tempindex_y], t * dt, T_period) * rootpsix;
